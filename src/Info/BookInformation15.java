 ...
 * @author jesus
 */
public class BookInformation15 extends javax.swing.JFrame {

    
    /**
     * Creates new form BookInformation
     */
    public BookInformation15() {
        initComponents();
    ...
    private void initComponents() {
        ...
        JTitlespot.setText("Frankenstein");
        ...
        jTextPane1.setText("Tras la prematura muerte de su madre, Víctor Frankenstein se obsesiona con vencer la muerte. Decide entonces estudiar medicina y se interesa por los experimentos del profesor Waldman, que lo inspirarán para crear un monstruo de apariencia humana a partir de cadáveres.");
        ...
        jPanel1.add(libro13, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 90, 170, 190));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BookInformation15.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BookInformation15().setVisible(true);
            }
        });
    }
