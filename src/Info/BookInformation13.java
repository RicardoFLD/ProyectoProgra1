 ...
 * @author jesus
 */
public class BookInformation13 extends javax.swing.JFrame {

    
    /**
     * Creates new form BookInformation
     */
    public BookInformation13() {
        initComponents();
    ...
    private void initComponents() {
        ...
        JTitlespot.setText("Harry Potter");
        ...
        jTextPane1.setText("El día de su cumpleaños, Harry Potter descubre que es hijo de dos conocidos hechiceros, de los que ha heredado poderes mágicos. Debe asistir a una famosa escuela de magia y hechicería, donde entabla una amistad con dos jóvenes que se convertirán en sus compañeros de aventura. Durante su primer año en Hogwarts, descubre que un malévolo y poderoso mago llamado Voldemort está en busca de una piedra filosofal que alarga la vida de quien la posee.");
        ...
        jPanel1.add(libro11, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 90, 170, 190));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BookInformation13.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BookInformation13().setVisible(true);
            }
        });
    }
