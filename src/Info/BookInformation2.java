 ...
 * @author jesus
 */
public class BookInformation2 extends javax.swing.JFrame {

    
    /**
     * Creates new form BookInformation
     */
    public BookInformation2() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BookInformation2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BookInformation2().setVisible(true);
            }
        });
    }
