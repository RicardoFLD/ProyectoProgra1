 ...
 * @author jesus
 */
public class BookInformation6 extends javax.swing.JFrame {

    
    /**
     * Creates new form BookInformation
     */
    public BookInformation6() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jTextPane1.setText("En 1993, tres niños de 8 años fueron brutalmente asesinados en un barrio de Memphis. Tres chicos de indumentaria gótica e interesados por el satanismo, \"Los tres de West Memphis\", eran los sospechosos perfectos para satisfacer a la opinión pública.");
        jScrollPane1.setViewportView(jTextPane1);

        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 90, 310, 190));

        libro9.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        jPanel1.add(libro9, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 90, 180, 190));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BookInformation6.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BookInformation6().setVisible(true);
            }
        });
    }
