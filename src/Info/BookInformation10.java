 ...
 * @author jesus
 */
public class BookInformation10 extends javax.swing.JFrame {

    
    /**
     * Creates new form BookInformation
     */
    public BookInformation10() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jTextPane1.setText("El narrador, heredero de su legado, se vuelca en la interpretación arqueológica de un bajorrelieve que va acompañado de un texto en una lengua desconocida que hace referencia a un culto secreto del que parece ser un dios olvidado y extraterrestre con el nombre de «Cthulhu».");
        ...
        jPanel1.add(libro15, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 90, 180, 190));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BookInformation10.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BookInformation10().setVisible(true);
            }
        });
    }
