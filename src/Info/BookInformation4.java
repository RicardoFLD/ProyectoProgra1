 ...
 * @author jesus
 */
public class BookInformation4 extends javax.swing.JFrame {

    
    /**
     * Creates new form BookInformation
     */
    public BookInformation4() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel1.add(Jauthor, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 20, 150, 20));
        ...
        JTitlespot.setText("Cementerio de mascotas");
        ...
        jPanel1.add(JTitlespot, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 20, 210, -1));
        ...
        jScrollPane1.setToolTipText("El Dr. Louis Creed descubre un cementerio extraño en un bosque cercano a su nueva casa. Cuando el gato de la familia muere atropellado, Louis lo entierra en ese inquietante cementerio y, lo que ocurre después, le aterra tanto como le fascina.");

        jTextPane1.setBackground(new java.awt.Color(255, 255, 255));
        jTextPane1.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        jTextPane1.setForeground(new java.awt.Color(0, 0, 0));
        jTextPane1.setText("El Dr. Louis Creed descubre un cementerio extraño en un bosque cercano a su nueva casa. Cuando el gato de la familia muere atropellado, Louis lo entierra en ese inquietante cementerio y, lo que ocurre después, le aterra tanto como le fascina.");
        ...
        jPanel1.add(libro4, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 90, 180, 190));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BookInformation4.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BookInformation4().setVisible(true);
            }
        });
    }
