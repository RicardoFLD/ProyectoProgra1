 ...
 * @author jesus
 */
public class BookInformation3 extends javax.swing.JFrame {

    
    /**
     * Creates new form BookInformation
     */
    public BookInformation3() {
        initComponents();
    ...
    private void initComponents() {
        ...
        JTitlespot.setText("Bazar de los malos sueños");
        ...
        jTextPane1.setText("En esta ocasión trata temas,como la moralidad,la vida después de la muerte,la culpa y lo que corregiramos del pasado si pudiésemos ver el futuro. Magníficos,inquietantes,absorbentes,estos cuentos suponen uno de los más preciados regalos de King a sus lectores.");
        ...
        jPanel1.add(libro3, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 90, 180, 190));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BookInformation3.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BookInformation3().setVisible(true);
            }
        });
    }
