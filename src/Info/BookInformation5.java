 ...
 * @author jesus
 */
public class BookInformation5 extends javax.swing.JFrame {

    
    /**
     * Creates new form BookInformation
     */
    public BookInformation5() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel1.add(Jauthor, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 20, 150, 20));
        ...
        JTitlespot.setText("Condenados Invasión de las tinieblas");
        ...
        jPanel1.add(JTitlespot, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 20, 290, -1));
        ...
        jTextPane1.setText("Londres es una ciudad fantasma invadida por oleadas de seres procedentes de las tinieblas. Seres que, tras aparecer de la nada, han provocado un devastador incendio y siguen llegando sin descanso, como la crecida de un río enorme. Un río que tiene su origen en el Inframundo.");
        ...
        jPanel1.add(libro6, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 90, 170, 190));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BookInformation5.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BookInformation5().setVisible(true);
            }
        });
    }
