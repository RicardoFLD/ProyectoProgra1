 ...
 * @author jesus
 */
public class BookInformation16 extends javax.swing.JFrame {

    
    /**
     * Creates new form BookInformation
     */
    public BookInformation16() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel1.add(Jauthor, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 20, 150, 20));
        ...
        JTitlespot.setText("La divina comedia");
        ...
        jPanel1.add(JTitlespot, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 20, 170, -1));
        ...
        jTextPane1.setText("Es una obra humana que refleja el peregrinaje del ser humano en busca de “la Luz”, es el descubrimiento del hombre hacia Dios, con la ayuda de la razón (Virgilio) y de la fe (Beatriz). El poema es una epopeya religiosa que narra con realismo un viaje, es un canto a la humanidad.");
        ...
        jPanel1.add(libro20, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 90, 170, 190));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BookInformation16.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BookInformation16().setVisible(true);
            }
        });
    }
